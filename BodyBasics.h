...
private:
    ...
    ID2D1SolidColorBrush* m_pBrushBallCollision;
    ...
    void CheckCollisionAndChangeColor(const D2D1_POINT_2F& jointPoint, std::vector<D2D1_POINT_2F>& ballPositions, bool *tracked);
};
